  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={heroImage} alt="Tanzanian women and girls using health technology in their community" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-20">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#get-involved" className="bg-gold-gradient text-foreground px-8 py-4 rounded-lg font-body font-bold text-lg hover:scale-105 transition-transform flex items-center gap-2 shadow-lg">
              <Heart size={20} />
              {t("hero.donateNow")}
            </a>
            <a href="#about" className="border-2 border-primary-foreground/30 text-primary-foreground px-8 py-4 rounded-lg font-body font-semibold text-lg hover:bg-primary-foreground/10 transition-colors flex items-center gap-2">
              <Users size={20} />
